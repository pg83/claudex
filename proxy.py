#!/usr/bin/env python3
"""Claudex proxy: config loading + CLI dispatcher.

Server logic lives in cmd_serve.py; per-subcommand handlers live in
their own cmd_*.py modules. Importing this module is side-effect-free
beyond module-level constants.
"""
